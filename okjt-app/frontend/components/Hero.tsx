        ...
        <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
            ...
            <motion.div className="container relative z-10 mx-auto px-6 pt-32 pb-20" style={{ opacity }}>
                ...
                >
                    {/* Pill Badge */}
                    {isLoading ? (
                        <SkeletonBlock className="h-10 w-64 rounded-full mx-auto mb-10" />
                    ) : tagline && (
                        <motion.div
                            variants={fadeUp}
                    ...
                    >
                        {isLoading ? (
                            <div className="mx-auto max-w-4xl space-y-5">
                                <SkeletonBlock className="h-14 md:h-20 w-full rounded-md" />
                                <SkeletonBlock className="h-14 md:h-20 w-4/5 rounded-md mx-auto" />
                            </div>
                        ) : (
                            <>
                                {titleLine1}<br />
                    ...
                    {/* Subheadline */}
                    {isLoading ? (
                        <SkeletonText lines={2} className="max-w-3xl mx-auto mb-14" />
                    ) : subtitle && (
                        <motion.p
                            variants={fadeUp}
