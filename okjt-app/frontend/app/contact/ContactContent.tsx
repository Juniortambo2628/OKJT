        ...
        <main className="flex min-h-screen flex-col relative bg-background w-full overflow-x-clip">
            ...
            >
                <div className="w-full max-w-4xl mx-auto">
                    ...
                    {/* Form Card */}
                    <div className="bg-black/50 backdrop-blur-xl border border-white/10 p-8 md:p-12 shadow-xl shadow-black/10 rounded-2xl">
                        <div className="mb-12">
            ...
            >
                <div className="w-full max-w-4xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        ...
                        <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} className="p-8 border border-white/10 bg-black/40 backdrop-blur-md flex flex-col justify-center rounded-2xl">
